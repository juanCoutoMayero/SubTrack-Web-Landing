...
const AppStoreButton: React.FC = () => {
  return (
    <button className="flex items-center gap-3 bg-white text-[#1A120D] px-8 py-4 rounded-2xl hover:bg-[#F59773] transition-all duration-300 shadow-xl hover:shadow-[#F59773]/20 group">
